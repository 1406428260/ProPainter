...
class Trainer:
    def __init__(self, config):
        ...
        self.netG = net.RecurrentFlowCompleteNet(config['model']['ckpt'])
        # print(self.netG)
    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            if self.config['distributed']:
                ...
                pred_flows_bi, pred_edges_bi = self.netG.forward_bidirect_flow(gt_flows_bi, local_masks)
            ...
            if self.iteration % self.train_args['vis_freq'] == 0 and self.gen_writer is not None:
                t = 5     
                # forward to cpu
