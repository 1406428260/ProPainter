...
class BidirectionalPropagation(nn.Module):
    ...
    def forward(self, x, flows_forward, flows_backward, mask, interpolation='bilinear'):
        ...
        # prop_list = ['forward_1', 'backward_1']
            ...
            for i, idx in enumerate(frame_idx):
                ...
                if i == 0:
                    ...
                    if self.learnable:
                        ...
                        mask_prop_valid = self.binary_mask(mask_prop_valid)  # 前一帧mask warp到当前帧

                        union_vaild_mask = self.binary_mask(mask_current*flow_vaild_mask*(1-mask_prop_valid)) # 当前mask区域*上一帧warp后的mask的非，还剩下哪些没被补全的
        ...
        if self.learnable:
            ...
            masks_b, masks_f, masks_out = None, None, None
        ...
        return outputs_b.view(b, -1, c, h, w), outputs_f.view(b, -1, c, h, w), \
               outputs.view(b, -1, c, h, w), masks_out
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, init_weights=True, model_path=None):
        ...
        if model_path != '' and model_path is not None:
            print(f'Pretrained ProPainter {model_path} has loaded...')
